...
reason: appointment.reason || '已取消',
    ...
    const response = {
      appointment: {
        ...
        patientGender: appointment.patient.user.gender ?? null,
        patientDateOfBirth: appointment.patient.user.dateOfBirth ? appointment.patient.user.dateOfBirth.toISOString() : null,
        patientCredibilityScore: appointment.patient.credibilityScore ?? null,
